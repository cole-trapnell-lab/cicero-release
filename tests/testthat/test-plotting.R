...
test_that("plot_accessibility_in_pseudotime works", {
  ...
  temp <- c(3.48, 2.19, 0.70, 0.95, 3.19, 2.31, 2.26, 1.54, 4.00, 2.87, 1.11, 
            2.36, 2.11, 0.58, 3.58, 1.02, 0.15, 4.30, 3.59, 3.00, 2.71, 0.18, 
            3.63, 3.02, 3.31, 3.61, 2.70, 0.85, 0.11, 0.13, 3.54, 2.75, 2.51, 
            2.27, 0.24, 3.14, 2.80, 2.21, 0.26, 3.60, 3.07, 2.45, 0.23, 0.21, 
            0, 4.84, 2.03, 3.13, 3.40, 2.03, 2.38, 2.65, 0.75, 4.65, 3.59, 
            2.79, 4.36, 3.66, 0.15, 0.23, 3.00, 4.46, 2.95, 2.81, 3.10, 0.94, 
            3.60, 3.68, 2.46, 2.87, 1.94, 0.10, 2.29, 0.60, 2.23, 0.15, 4.17, 
            2.74, 4.44, 2.65, 2.22, 2.93, 3.23, 3.57, 1.75, 0.21, 1.92, 0.24, 
            3.54, 2.77, 2.57, 2.42, 3.72, 4.57, 3.57, 3.56, 3.66, 3.55, 2.02,
            3.08, 2.13, 2.21, 4.43, 0.14, 2.92, 0.17, 3.02, 3.61, 2.52, 3.12, 
            2.2, 1.60, 4.19, 3.76, 1.35, 2.40, 0.72, 3.30, 3.23, 4.40, 3.23, 
            3.55, 4.39, 2.20, 0.17, 0.28, 2.93, 3.63, 4.51, 2.22, 2.91, 4.15, 
            1.87, 3.30, 2.96, 4.18, 0.44, 3.59, 4.52, 0.46, 3.55, 3.13, 4.42, 
            3.59, 1.12, 2.78, 0.81, 3.34, 2.37, 3.00, 1.89, 0.18, 3.68, 1.04, 
            2.81, 3.00, 2.95, 0.26, 3.24, 4.52, 2.90, 4.35, 2.79, 2.19, 3.13, 
            1.10, 2.13, 4.12, 2.80, 0.06, 0.11, 2.54, 0.12, 3.66, 1.30, 2.93,
            0.26, 0.05, 4.33, 4.26, 2.84, 3.04, 1.02, 2.81, 4.17, 1.60, 2.76, 
            2.77, 2.24, 0.19, 3.35, 3.05, 0.19, 3.00, 0.14, 2.15, 3.93, 1.16, 
            0.10, 2.01)
  names(temp) <- row.names(pData(input_cds))

  input_cds@principal_graph_aux[["UMAP"]]$pseudotime <- temp
